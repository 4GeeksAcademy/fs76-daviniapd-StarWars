...
export const DpdNavbar = () => {
	...
	return (
		<nav className="navbar navbar-expand-md navbar-dark bg-black" style={{ zIndex: 1000 }}>
			<div className="row d-flex justify-content-around align-items-center w-100">
				<div className="col-md-2 col-sm-6 col-xs-6 order-md-1 order-sm-1 order-xs-1 d-flex justify-content-center">
				...
				<div className="col-md-8 col-sm-12 col-xs-12 order-md-2 order-sm-3 order-xs-3 d-flex justify-content-center my-2">
					<DpdSearch />
				</div>
				<div className="col-md-2 col-sm-6 col-xs-6 order-md-3 order-sm-2 order-xs-2 d-flex justify-content-center my-2">
					<div className="btn-group ml-auto h-50 my-auto">
						<button type="button" className="btn btn-outline-light dropdown-toggle py-1 px-2" data-bs-toggle="dropdown" aria-expanded="false" id="btnFavDpd">
							Likes
